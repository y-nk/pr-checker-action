...
var title = github.context.payload && github.context.payload.pull_request && github.context.payload.pull_request.title;
var labels = github.context.payload && github.context.payload.pull_request && github.context.payload.pull_request.labels && github.context.payload.pull_request.labels.map(({ name }) => name);
var regexp = core.getInput("regexp") || "^(milestone|break|feat|fix|hotfix|chore|misc|ci|docs|revert)(\\(\\w+\\))?!?:\\s([A-Z]{1,5}-[0-9]{1,}\\s).+";
var message = core.getInput("message") || "PR title does not follow team guidelines.";
var skip_on = core.getInput("skip_on");
